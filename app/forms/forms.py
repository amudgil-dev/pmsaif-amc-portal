...
class PMSMasterEditForm(FlaskForm):
    ...
    stocks_min = IntegerField('Stocks Min', validators=[DataRequired() ,NumberRange(min=0)])
    stocks_max = IntegerField('Stocks Max', validators=[DataRequired() ,NumberRange(min=0)])
